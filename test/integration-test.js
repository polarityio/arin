...
describe('Polarity Arin Integration', () => {
    ...
    describe('_processRequest', () => {
        it('should return HTTP error', (done) => {
            integration._processRequest("error", null, null, null, (err, result) => {
        ...
        it('should return 500 error', (done) => {
            integration._processRequest(null, {statusCode: 500}, null, null, (err, result) => {
                //console.info(JSON.stringify(err, null, 4));
                expect(err).to.deep.equal({
                        "errors": [
                            {
        ...
        it('should return empty result for 404 results', (done) => {
            integration._processRequest(null, {statusCode: 404}, null, {value: 'entity'}, (err, result) => {
        ...
        it('should return error for 400 results', (done) => {
            integration._processRequest(null, {statusCode: 400}, null, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(err, null, 4));
                expect(err).to.deep.equal({
                        "errors": [
                            {
        ...
        it('should return error for non 200 results', (done) => {
            integration._processRequest(null, {statusCode: 580}, null, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(err, null, 4));
                expect(err).to.deep.equal({
                        "errors": [
                            {
        ...
        it('should return empty result for undefined body', (done) => {
            integration._processRequest(null, {statusCode: 200}, undefined, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result for null body', (done) => {
            integration._processRequest(null, {statusCode: 200}, null, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result for undefined body.net', (done) => {
            integration._processRequest(null, {statusCode: 200}, {net: undefined}, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result for null body.net', (done) => {
            integration._processRequest(null, {statusCode: 200}, {net: null}, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result for undefined body.net.parentNetRef', (done) => {
            integration._processRequest(null, {statusCode: 200}, {net: {parentNetRef: undefined}}, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result for null body.net.parentNetRef', (done) => {
            integration._processRequest(null, {statusCode: 200}, {net: {parentNetRef: null}}, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result for undefined body.net.orgRef', (done) => {
            integration._processRequest(null, {statusCode: 200}, {net: {orgRef: undefined}}, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result for null body.net.orgRef', (done) => {
            integration._processRequest(null, {statusCode: 200}, {net: {orgRef: null}}, {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should return empty result if body is a string', (done) => {
            integration._processRequest(null, {statusCode: 200}, "string", {value: 'entity'}, (err, result) => {
                //console.info(JSON.stringify(result, null, 4));
                expect(err).to.be.null;
                expect(result).to.deep.equal({
                        "entity": {
        ...
        it('should get cidrLength from netBlock array', (done) => {
            integration._processRequest(null, {statusCode: 200}, {
                net: {
                    parentNetRef: '',
                    orgRef: '',
                    netBlocks: {
